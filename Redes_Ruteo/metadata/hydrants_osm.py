...
load_dotenv()
OUT = Path(__file__).resolve().parent / "hydrants.geojson"
...
node["emergency"="fire_hydrant"]({BBOX_S},{BBOX_W},{BBOX_N},{BBOX_E});
out body;
"""

def main():
    print("[E] Descargando hidrantes desde OSM…")
    ...
    print(f"[OK] Guardado {OUT} con {len(features)} hidrantes.")
